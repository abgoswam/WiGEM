...
maximum a posteriori estimate. {\color{red} The key insight is to use the physics of wireless propagation, and exploit the signal strength constraints that exist for different power levels.} A learning approach not only avoids the 
labor-intensive
...
Android-based phones, Laptops and Netbooks). We demonstrate that WiGEM's
